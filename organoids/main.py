...
async def run_workflow():
    ...
    user_prompt = (
        "I have uploaded a microscopy image showing organoids. "
        "Please analyze it to find all visible organoids and specifically mark any budding regions, "
        "centers, and edge points on each organoid structure you can see."
    )
