...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "image_path",
        nargs="?",
        default="/N/slate/hungill/organoids/data/data/imgs/org64_B2A-2_d19_LabA.jpg", #"demo_image3.jpg",
        help="Path to the input image (default: demo.jpg)"
    )

    # /N/slate/hungill/organoids/data/data/imgs/org25_TH2-7_d19_LabA.jpg
    args = parser.parse_args()
    # /N/slate/hungill/organoids/data/budding/train/budding/f6 10x.jpg
    #/N/slate/hungill/organoids/data/budding/train/budding/h8 10x (2).jpg
